...
create table hop (dtype varchar(31) not null, id int8 not null, code varchar(255) not null, description varchar(255), hop_type varchar(255), location_name varchar(255), processing_delay_mins int4, number_plate varchar(255), region_geo_json varchar(255), level int4, location_coordinates_id int8 not null, primary key (id));
...
create table warehouse_next_hop (id int8 not null, traveltime_mins int4, hop_id int8, primary key (id));
